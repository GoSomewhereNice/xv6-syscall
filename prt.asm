...
main(int argc, char *argv[])
{
  ...
  1c:	7e 23                	jle    41 <main+0x41>
    n = 1;
  else
    n = atoi (argv[1]);
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	ff 77 04             	pushl  0x4(%edi)
  24:	e8 37 02 00 00       	call   260 <atoi>
  if( n < 0 || n > 20)
  29:	83 c4 10             	add    $0x10,%esp
  2c:	83 f8 14             	cmp    $0x14,%eax
  double x=0, z, d;
  ...
  if(argc < 3)
  3b:	75 3c                	jne    79 <main+0x79>
    d = 1.0;
  3d:	d9 e8                	fld1   
  3f:	eb 10                	jmp    51 <main+0x51>
{
  int k, n;
  double x=0, z, d;
  ...
  if( n < 0 || n > 20)
    n = 2;
  if(argc < 3)
  46:	83 fb 02             	cmp    $0x2,%ebx
  49:	7f 2e                	jg     79 <main+0x79>
    d = 1.0;
  4b:	d9 e8                	fld1   
  else
    d = atoi (argv[2]);
  ...
  53:	dd 05 50 07 00 00    	fldl   0x750
  59:	d9 c9                	fxch   %st(1)
  5b:	eb 05                	jmp    62 <main+0x62>
  5d:	8d 76 00             	lea    0x0(%esi),%esi
  60:	d9 c9                	fxch   %st(1)
  62:	d8 c2                	fadd   %st(2),%st
  64:	d9 c9                	fxch   %st(1)
  66:	db e9                	fucomi %st(1),%st
  68:	77 f6                	ja     60 <main+0x60>
  6a:	dd d8                	fstp   %st(0)
  6c:	dd d8                	fstp   %st(0)
  6e:	dd d8                	fstp   %st(0)
  70:	eb 02                	jmp    74 <main+0x74>
  72:	dd d8                	fstp   %st(0)
        x = x + 3.14 * 89.64 ;
      break;
  }
  ...
  7c:	ff 77 08             	pushl  0x8(%edi)
  7f:	e8 dc 01 00 00       	call   260 <atoi>
  84:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  87:	83 c4 10             	add    $0x10,%esp
  8a:	db 45 e4             	fildl  -0x1c(%ebp)
  8d:	eb be                	jmp    4d <main+0x4d>
  8f:	90                   	nop
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 58 07 00 00       	mov    $0x758,%eax
