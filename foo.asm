  ...
  4c:	dd 5d e0             	fstpl  -0x20(%ebp)
{
  ...
  93:	83 c3 01             	add    $0x1,%ebx
    ...
    if ( id < 0 ) {
      printf(1, "%d failed in fork!\n", getpid() );
  96:	50                   	push   %eax
  97:	68 e0 07 00 00       	push   $0x7e0
  9c:	6a 01                	push   $0x1
  9e:	e8 1d 04 00 00       	call   4c0 <printf>
  ...
  d6:	d9 e8                	fld1   
{
  ...
  fa:	83 c4 10             	add    $0x10,%esp
       for ( z = 0; z < 8000000.0; z += d )
  fd:	d9 05 24 08 00 00    	flds   0x824
 103:	d9 c9                	fxch   %st(1)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 28 08 00 00       	mov    $0x828,%eax
...
free(void *ap)
{
 ...
 6b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6b9:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 d4 0a 00 00       	mov    %eax,0xad4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 74f:	76 3f                	jbe    790 <malloc+0xa0>
    ...
    if(p == freep)
 751:	39 05 d4 0a 00 00    	cmp    %eax,0xad4
 ...
 776:	e8 e5 fe ff ff       	call   660 <free>
  return freep;
 77b:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 d4 0a 00 00    	mov    %edx,0xad4
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 d4 0a 00 00 d8 	movl   $0xad8,0xad4
 7bd:	0a 00 00 
 7c0:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	b8 d8 0a 00 00       	mov    $0xad8,%eax
 7cf:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 7d6:	00 00 00 
