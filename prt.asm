  ...
  4c:	dd 5d e0             	fstpl  -0x20(%ebp)
{
  ...
  58:	0f 84 8f 00 00 00    	je     ed <main+0xed>
      printf(1, "Parent %d creating child %d\n",getpid(), id, "\n");
  5e:	e8 9f 03 00 00       	call   402 <getpid>
  ...
  66:	83 c3 01             	add    $0x1,%ebx
    ...
    if(id<0){
      ...
      printf(1, "Parent %d creating child %d\n",getpid(), id, "\n");
  69:	68 12 08 00 00       	push   $0x812
  6e:	56                   	push   %esi
  6f:	50                   	push   %eax
  70:	68 14 08 00 00       	push   $0x814
  75:	6a 01                	push   $0x1
  77:	e8 64 04 00 00       	call   4e0 <printf>
      wait();
  7c:	83 c4 20             	add    $0x20,%esp
  7f:	e8 06 03 00 00       	call   38a <wait>
  else
    d = atoi (argv[2]);
  ...
  id= 0;
  for(k = 0; k < n; k++){
  84:	39 fb                	cmp    %edi,%ebx
  86:	7d 30                	jge    b8 <main+0xb8>
    id = fork();
  88:	e8 ed 02 00 00       	call   37a <fork>
    if(id<0){
  ...
  8f:	89 c6                	mov    %eax,%esi
    if(id<0){
  91:	79 c5                	jns    58 <main+0x58>
      printf(1, "%d failed in fork!\n",getpid() ,"\n");
  93:	e8 6a 03 00 00       	call   402 <getpid>
  98:	68 12 08 00 00       	push   $0x812
  9d:	50                   	push   %eax
  else
    d = atoi (argv[2]);
  ...
  exit();
  b8:	e8 c5 02 00 00       	call   382 <exit>
  if( n < 0 || n > 20)
    n = 2;
  if(argc < 3)
    d = 1.0;
  ...
  c0:	ff 76 08             	pushl  0x8(%esi)
  c3:	e8 48 02 00 00       	call   310 <atoi>
  c8:	89 45 e0             	mov    %eax,-0x20(%ebp)
  cb:	83 c4 10             	add    $0x10,%esp
  ce:	db 45 e0             	fildl  -0x20(%ebp)
  d1:	dd 5d e0             	fstpl  -0x20(%ebp)

  x = 0;
  id= 0;
  for(k = 0; k < n; k++){
  d4:	85 ff                	test   %edi,%edi
  d6:	0f 85 73 ff ff ff    	jne    4f <main+0x4f>
  dc:	eb da                	jmp    b8 <main+0xb8>
  else
    n = atoi (argv[1]);
  if( n < 0 || n > 20)
    n = 2;
  ...
  de:	d9 e8                	fld1   
{
  ...
  if(argc < 3)
    d = 1.0;
  e5:	dd 5d e0             	fstpl  -0x20(%ebp)
  e8:	e9 62 ff ff ff       	jmp    4f <main+0x4f>
      printf(1, "%d failed in fork!\n",getpid() ,"\n");
    }else if(id > 0){
      printf(1, "Parent %d creating child %d\n",getpid(), id, "\n");
      wait();
  ...
  ed:	e8 10 03 00 00       	call   402 <getpid>
  f2:	68 12 08 00 00       	push   $0x812
  f7:	50                   	push   %eax
  f8:	68 31 08 00 00       	push   $0x831
  fd:	6a 01                	push   $0x1
 ...
 106:	83 c4 10             	add    $0x10,%esp
      for(z=0; z<8000000.0; z+=d)
 109:	d9 05 44 08 00 00    	flds   0x844
 10f:	d9 c9                	fxch   %st(1)
 111:	eb 07                	jmp    11a <main+0x11a>
 113:	90                   	nop
 ...
 12c:	75 8f                	jne    bd <main+0xbd>
    d = 1.0;
 12e:	d9 e8                	fld1   
 130:	dd 5d e0             	fstpl  -0x20(%ebp)
 133:	eb 9f                	jmp    d4 <main+0xd4>
...
putc(int fd, char c)
{
 ...
 5f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5fb:	b8 48 08 00 00       	mov    $0x848,%eax
...
free(void *ap)
{
 ...
 6d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6d9:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 6de:	5b                   	pop    %ebx
 6df:	5e                   	pop    %esi
 6e0:	5f                   	pop    %edi
 ...
 6fa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6fd:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
