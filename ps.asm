...
main(int argc, char *argv[]){  
  ...
  10:	8d 85 d0 fe ff ff    	lea    -0x130(%ebp),%eax
};
...
int
main(int argc, char *argv[]){  
  16:	81 ec 34 01 00 00    	sub    $0x134,%esp
  struct proc ptable[MAX_PROC];
  struct proc *p;
  int err;
  ...
  err = getptable(10*sizeof(struct proc),&ptable);
  1c:	50                   	push   %eax
  1d:	68 18 01 00 00       	push   $0x118
  22:	e8 4b 04 00 00       	call   472 <getptable>
  if(err !=0)
  27:	83 c4 10             	add    $0x10,%esp
  2a:	85 c0                	test   %eax,%eax
  2c:	0f 85 3a 01 00 00    	jne    16c <main+0x16c>
    printf(1,"Error getting ptable");
  
  p = &ptable[0];
  printf(1, " PID  PPID  STATE  CMD \n");
  32:	83 ec 08             	sub    $0x8,%esp
  35:	8d 9d dc fe ff ff    	lea    -0x124(%ebp),%ebx
  3b:	8d 75 bc             	lea    -0x44(%ebp),%esi
  3e:	68 55 08 00 00       	push   $0x855
  43:	6a 01                	push   $0x1
  45:	e8 d6 04 00 00       	call   520 <printf>
  while(p != &ptable[MAX_PROC-1] && p->state != UNUSED){
  4a:	8b 95 d0 fe ff ff    	mov    -0x130(%ebp),%edx
  50:	83 c4 10             	add    $0x10,%esp
  53:	85 d2                	test   %edx,%edx
  55:	74 6a                	je     c1 <main+0xc1>
  57:	89 f6                	mov    %esi,%esi
  59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  	printf(1,"%d  %d ",p->pid,p->ppid);
  60:	ff 73 fc             	pushl  -0x4(%ebx)
  63:	ff 73 f8             	pushl  -0x8(%ebx)
  66:	68 6e 08 00 00       	push   $0x86e
  6b:	6a 01                	push   $0x1
  6d:	e8 ae 04 00 00       	call   520 <printf>
  	switch(p->state){
  72:	83 c4 10             	add    $0x10,%esp
  75:	83 7b f4 05          	cmpl   $0x5,-0xc(%ebx)
  79:	77 25                	ja     a0 <main+0xa0>
  7b:	8b 43 f4             	mov    -0xc(%ebx),%eax
  7e:	ff 24 85 b0 08 00 00 	jmp    *0x8b0(,%eax,4)
  ...
  8b:	68 9b 08 00 00       	push   $0x89b
  90:	68 7d 08 00 00       	push   $0x87d
  95:	6a 01                	push   $0x1
  ...
  a3:	53                   	push   %ebx
  a4:	68 aa 08 00 00       	push   $0x8aa
  a9:	6a 01                	push   $0x1
  ab:	e8 70 04 00 00       	call   520 <printf>
  if(err !=0)
    printf(1,"Error getting ptable");
  ...
  b5:	74 0a                	je     c1 <main+0xc1>
  b7:	83 c3 1c             	add    $0x1c,%ebx
  ba:	8b 43 f4             	mov    -0xc(%ebx),%eax
  bd:	85 c0                	test   %eax,%eax
  bf:	75 9f                	jne    60 <main+0x60>
  	} 
  	printf(1," %s \n", p->name);
  	p++;
  }
  ...
  exit();
  c1:	e8 0c 03 00 00       	call   3d2 <exit>
  ...
  d3:	68 76 08 00 00       	push   $0x876
  d8:	68 7d 08 00 00       	push   $0x87d
  dd:	6a 01                	push   $0x1
  df:	e8 3c 04 00 00       	call   520 <printf>
  		break;
  e4:	83 c4 10             	add    $0x10,%esp
  e7:	eb b7                	jmp    a0 <main+0xa0>
  ...
  f3:	68 a3 08 00 00       	push   $0x8a3
  f8:	68 7d 08 00 00       	push   $0x87d
  fd:	6a 01                	push   $0x1
  ff:	e8 1c 04 00 00       	call   520 <printf>
  		break;
 104:	83 c4 10             	add    $0x10,%esp
 107:	eb 97                	jmp    a0 <main+0xa0>
 ...
 113:	68 89 08 00 00       	push   $0x889
 118:	68 7d 08 00 00       	push   $0x87d
 11d:	6a 01                	push   $0x1
 11f:	e8 fc 03 00 00       	call   520 <printf>
  		break;
 124:	83 c4 10             	add    $0x10,%esp
 127:	e9 74 ff ff ff       	jmp    a0 <main+0xa0>
 ...
 133:	68 82 08 00 00       	push   $0x882
 138:	68 7d 08 00 00       	push   $0x87d
 13d:	6a 01                	push   $0x1
 13f:	e8 dc 03 00 00       	call   520 <printf>
  		break;
 144:	83 c4 10             	add    $0x10,%esp
 147:	e9 54 ff ff ff       	jmp    a0 <main+0xa0>
 ...
 153:	68 92 08 00 00       	push   $0x892
 158:	68 7d 08 00 00       	push   $0x87d
 15d:	6a 01                	push   $0x1
 15f:	e8 bc 03 00 00       	call   520 <printf>
  		break;
 164:	83 c4 10             	add    $0x10,%esp
 167:	e9 34 ff ff ff       	jmp    a0 <main+0xa0>
  struct proc *p;
  int err;
 ...
 16c:	51                   	push   %ecx
 16d:	51                   	push   %ecx
 16e:	68 40 08 00 00       	push   $0x840
 173:	6a 01                	push   $0x1
 175:	e8 a6 03 00 00       	call   520 <printf>
 17a:	83 c4 10             	add    $0x10,%esp
 17d:	e9 b0 fe ff ff       	jmp    32 <main+0x32>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bf:	f7 f6                	div    %esi
 4c1:	0f b6 92 d0 08 00 00 	movzbl 0x8d0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 638:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 63b:	b8 c8 08 00 00       	mov    $0x8c8,%eax
...
free(void *ap)
{
 ...
 717:	89 08                	mov    %ecx,(%eax)
  freep = p;
 719:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 71e:	5b                   	pop    %ebx
 71f:	5e                   	pop    %esi
 720:	5f                   	pop    %edi
 ...
 73a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 73d:	a3 70 0b 00 00       	mov    %eax,0xb70
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 70 0b 00 00    	mov    0xb70,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7af:	76 3f                	jbe    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	39 05 70 0b 00 00    	cmp    %eax,0xb70
 ...
 7d6:	e8 e5 fe ff ff       	call   6c0 <free>
  return freep;
 7db:	8b 15 70 0b 00 00    	mov    0xb70,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7ff:	89 15 70 0b 00 00    	mov    %edx,0xb70
      return (void*)(p + 1);
 ...
 814:	eb e9                	jmp    7ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 816:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 81d:	0b 00 00 
 820:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 827:	0b 00 00 
    base.s.size = 0;
 82a:	b8 74 0b 00 00       	mov    $0xb74,%eax
 82f:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 836:	00 00 00 
