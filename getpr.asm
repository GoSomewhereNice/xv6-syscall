...
main(int argc, char *argv[])
{
  ...
  27:	e8 16 03 00 00       	call   342 <getpr>
...
main(int argc, char *argv[])
{
  ...
  31:	50                   	push   %eax
  32:	50                   	push   %eax
  33:	68 10 07 00 00       	push   $0x710
  38:	6a 02                	push   $0x2
  3a:	e8 b1 03 00 00       	call   3f0 <printf>
    exit();
  3f:	e8 4e 02 00 00       	call   292 <exit>
  44:	66 90                	xchg   %ax,%ax
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 22 07 00 00       	mov    $0x722,%eax
