...
main(int argc, char *argv[])
{
  ...
  1b:	7e 0e                	jle    2b <main+0x2b>
    n = 1;
  else
    n = atoi (argv[1]);
  1d:	83 ec 0c             	sub    $0xc,%esp
  20:	ff 73 04             	pushl  0x4(%ebx)
  23:	e8 f8 01 00 00       	call   220 <atoi>
  28:	83 c4 10             	add    $0x10,%esp
  if( n < 0 || n > 20)
    n = 2;
  if(argc < 3)
  2b:	83 fe 02             	cmp    $0x2,%esi
  2e:	7f 02                	jg     32 <main+0x32>
  30:	eb fe                	jmp    30 <main+0x30>
    d = 1.0;
  else
    d = atoi (argv[2]);
  32:	83 ec 0c             	sub    $0xc,%esp
  35:	ff 73 08             	pushl  0x8(%ebx)
  38:	e8 e3 01 00 00       	call   220 <atoi>
  3d:	83 c4 10             	add    $0x10,%esp
  40:	eb ee                	jmp    30 <main+0x30>
  42:	66 90                	xchg   %ax,%ax
  44:	66 90                	xchg   %ax,%ax
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 591:	a1 b8 09 00 00       	mov    0x9b8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 b8 09 00 00       	mov    %eax,0x9b8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 b8 09 00 00    	mov    0x9b8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 67f:	76 3f                	jbe    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	39 05 b8 09 00 00    	cmp    %eax,0x9b8
 ...
 6a6:	e8 e5 fe ff ff       	call   590 <free>
  return freep;
 6ab:	8b 15 b8 09 00 00    	mov    0x9b8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 b8 09 00 00    	mov    %edx,0x9b8
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 b8 09 00 00 bc 	movl   $0x9bc,0x9b8
 6ed:	09 00 00 
 6f0:	c7 05 bc 09 00 00 bc 	movl   $0x9bc,0x9bc
 6f7:	09 00 00 
    base.s.size = 0;
 6fa:	b8 bc 09 00 00       	mov    $0x9bc,%eax
 6ff:	c7 05 c0 09 00 00 00 	movl   $0x0,0x9c0
 706:	00 00 00 
